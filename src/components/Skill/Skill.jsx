...
function Skill() {
  ...
  const skillItem = [
    ...
    {
      id: 17,
      imgSrc: "https://upload.wikimedia.org/wikipedia/commons/0/0e/SQL_Database_Logo.svg",
      label: "MySQL",
    ...
    {
      id: 19,
      imgSrc: "https://upload.wikimedia.org/wikipedia/commons/f/fd/Jest_logo.svg",
      label: "Jest",
      desc: "Testing Framework",
    },
    {
      id: 20,
      imgSrc: "https://upload.wikimedia.org/wikipedia/commons/1/17/GraphQL_Logo.svg",
      label: "GraphQL",
      ...
      <div className="container">
            ...
            <ul className="mb-6 rounded-xl p-4 bg-skin-secondaryBackgroundColor shadow-sm">
              {filteredSkills.map((skill) => (
                ...
                >
                  ...
                  <span className="text-sm text-skin-secondary">{skill.desc}</span>
                </li>
              ))}
            </ul>
          )}
        ...
        <div className="grid gap-3 grid-cols-[repeat(auto-fit,_minmax(250px,_1fr))]">
          {users.skills.map(({ imgSrc, label, desc, id}) => (
            <SkillCard key={id} imgSrc={imgSrc} label={label} desc={desc} id={id} />
          ))}
        </div>
      </div>
    </section>
