...
function Hero() {
  ...
  />
      ...
      /> */}
            ...
            <div className="flex items-center gap-3">
              <ButtonPrimary label="Download CV" icon="download" href={"/resume.pdf"} />
            </div>
          </div>
          <div className="hidden lg:block">
            ...
            <figure
              ...
              style={{
                background: `linear-gradient(to top, ${users.bannerColor}, ${hexToRgba(users.bannerColor, 0.4)} 25%, ${hexToRgba(users.bannerColor, 0.0)} 67%)`,  // Applying the dynamic color with opacity in gradient
              }}
            ...
            {/* <input
              ...
              value={color}
            /> */}
            <div className={`flex justify-center items-center p-2 ${users.isAppEditable ? "visible" : "invisible"} `}>
